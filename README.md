...
> 🏛️ **Total State Support Use:** **`€63.58M`** *(Parliamentary operational grants)*  
> 🤝 **Total Private Donations:** **`€4.22M`** *(Corporate & individual contributions)*  
> 👥 **Total HR Expenses:** **`€27.16M`** *(Workforce & organizational operations)*  

---

### 🏆 Campaign Spending Allocation by Party

| Political Party | Total Spend | Share (%) | Key Campaign Peak |
| :--- | :---: | :---: | :--- |
| **Perussuomalaiset r.p.** | **€12.69M** | `43.2%` | Municipal & Regional Elections 2025 (**€5.03M**) |
| **Kansallinen Kokoomus r.p.** | **€6.81M** | `23.2%` | Parliamentary Elections 2023 (**€1.62M**) |
| **Suomen Sosialidemokraattinen Puolue r.p.** | **€4.63M** | `15.8%` | Parliamentary Elections 2023 (**€2.08M**) |
| **Suomen Keskusta r.p.** | **€2.97M** | `10.1%` | Parliamentary Elections 2023 (**€1.81M**) |
| **Vihreä liitto r.p.** | **€2.27M** | `7.7%` | Parliamentary Elections 2023 (**€0.99M**) |

---

## 🛠️ Data Pipeline & Technical Architecture

* 🔄 **ETL & Data Transformation (Power Query):** Extracted raw financial disclosures from `data_raw/`. Cleaned data types and explicitly removed summary rows (`KULUT YHTEENSÄ`) to eliminate double-counting risks.
...
* 🧮 **DAX Measures:** Structured explicit aggregation measures (`Total Campaign Expenses`, `Total State Support`, `Total HR Expenses`, `Total Donations`, `Total Financials`) in a dedicated measure group.
